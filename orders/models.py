...
class Order(models.Model):
    ...
    def update_total(self):
        ...
        new_total = math.fsum([cart_total, shiping_total])
...
def post_save_cart_order_id(sender, instance, created, *args, **kwargs):
    if not created:
        cart_obj = instance
...
post_save.connect(post_save_cart_order_id, sender=Cart)
